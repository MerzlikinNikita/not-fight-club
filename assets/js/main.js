  ...
  const battleActions = () => {
    ...
    attackBtn.addEventListener("click", () => {
      ...
      if (currentEnemyHealth <= 0) {
        ...
        const totalWins =
          parseInt(localStorage.getItem("totalWins") || "0") + 1;
    ...
    const getEnemyDefensePoints = () => {
      ...
      while (enemyDefensePoints.length !== 3) {
        ...
        if (
          !enemyDefensePoints.includes(defensePointsList[generatePointIndex])
        ) {
